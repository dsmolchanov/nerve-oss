...
func TestLegacyInitializeWireGolden(t *testing.T) {
	...
	want := legacyInitializeWireGolden
...
func TestLegacyResourcesListWireGolden(t *testing.T) {
	...
	want := legacyResourcesListWireGolden
	if got := recorder.Body.String(); got != want {
...
func TestLegacyToolsListWireGolden(t *testing.T) {
	...
	want := legacyToolsListWireGolden
	if got := recorder.Body.String(); got != want {
...
func TestLegacyBusinessErrorWireGolden(t *testing.T) {
	...
	tests := []struct {
		...
		{"quota", entitlements.ErrQuotaExceeded, legacyQuotaErrorWireGolden},
		{"subscription", entitlements.ErrSubscriptionInactive, legacySubscriptionErrorWireGolden},
		{"rate", &entitlements.RateLimitError{RetryAfterSeconds: 12}, legacyRateErrorWireGolden},
		{"idempotency", &entitlements.IdempotencyInProgressError{RetryAfterSeconds: 3}, legacyIdempotencyErrorWireGolden},
	}
